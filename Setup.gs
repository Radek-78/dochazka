...
const Setup = {
  ...
  setHeaders: function(sheet, sheetName) {
    ...
    switch (sheetName) {
      ...
      case DB_SHEETS.CORE.ATTENDANCE_STATUSES:
        headers = ["status_id", "name", "abbreviation", "color", "text_color", "category", "requires_approval", "allows_desk_reservation", "active", "is_vacation", "shows_work_time", "work_time_bg_color", "work_time_text_color", "status_kind", "masked_status_id", "retention_category", "allows_note"]; break;
      ...
      case DB_SHEETS.CORE.SECTION_VIEW_CONFIG:
        headers = ["section_id", "show_leader_first", "show_team_headers", "show_no_department_row", "config_json"]; break;
      ...
      case DB_SHEETS.CORE.RBAC_CONFIG:
        headers = ["rbac_key", "USER", "LEADER", "ADMIN", "SUPERADMIN", "MEMBER", "GROUP_LEADER", "DEPT_LEADER", "SECTION_LEADER"]; break;
  ...
  getExpectedHeaders: function(sheetName) {
    ...
    switch (sheetName) {
      ...
      case DB_SHEETS.CORE.ATTENDANCE_STATUSES: h = ["status_id", "name", "abbreviation", "color", "text_color", "category", "requires_approval", "allows_desk_reservation", "active", "is_vacation", "shows_work_time", "work_time_bg_color", "work_time_text_color", "status_kind", "masked_status_id", "retention_category", "allows_note"]; break;
      case DB_SHEETS.CORE.SECTION_VIEW_CONFIG: h = ["section_id", "show_leader_first", "show_team_headers", "show_no_department_row", "config_json"]; break;
