...
const Setup = {
  ...
  setHeaders: function(sheet, sheetName) {
    ...
    switch (sheetName) {
      ...
      case DB_SHEETS.CORE.ATTENDANCE_STATUSES:
        headers = ["status_id", "name", "abbreviation", "color", "text_color", "category", "requires_approval", "allows_desk_reservation", "active", "is_vacation", "shows_work_time", "work_time_bg_color", "work_time_text_color", "status_kind", "masked_status_id", "retention_category"]; break;
  ...
  getExpectedHeaders: function(sheetName) {
    ...
    switch (sheetName) {
      ...
      case DB_SHEETS.CORE.ATTENDANCE_STATUSES: h = ["status_id", "name", "abbreviation", "color", "text_color", "category", "requires_approval", "allows_desk_reservation", "active", "is_vacation", "shows_work_time", "work_time_bg_color", "work_time_text_color", "status_kind", "masked_status_id", "retention_category"]; break;
