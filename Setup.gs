...
const Setup = {
  ...
  getExpectedHeaders: function(sheetName) {
    ...
    switch (sheetName) {
      ...
      case DB_SHEETS.CORE.USERS: h = ["user_id", "email", "first_name", "last_name", "section_id", "department_id", "group_id", "position_id", "system_role", "org_role", "date_start", "date_end", "active", "auth_status", "last_active", "last_visit", "sync_own_attendance", "sync_team_vacations", "vacation_days_total", "vacation_days_carried_over"]; break;
      ...
      case DB_SHEETS.TRANSACTION.ATTENDANCE: h = ["attendance_id", "user_id", "date", "status_id", "slot", "note", "approved", "created_at"]; break;
