...
const APP_CHANGELOG = [
  ...
  },
  {
    ...
    "date": "2026-07-08",
    "changes": [
      "Log docházky a export nyní vylučují i uživatele, kteří mají v administraci proběhlé datum ukončení (dřív se filtrovalo jen podle příznaku active, takže se v logu/exportu mohli objevit i lidé vedení jako neaktivní kvůli odchodu)",
      "Počet zobrazených záznamů v Logu docházky nyní odpovídá aktivnímu filtru (\"Vyfiltrováno X z Y načtených\"), místo aby stále ukazoval celkový počet bez ohledu na filtr"
    ]
  },
  {
    "version": "2.13.8",
  ...
  },
  {
    ...
    "date": "2026-07-08",
    "changes": [
      "Export logu docházky: soubor se nyní vždy uloží do složky Exporty Docházky vedle databáze a navíc se mu (na Workspace doméně) předá vlastnictví uživateli, který export spustil - dřív se přesun do složky přeskočil, pokud se předání vlastnictví povedlo"
    ]
  },
  {
    "version": "2.13.6",
    "date": "2026-07-08",
    "changes": [
      "Export logu docházky do Sheets nyní primárně převádí vlastnictví souboru přímo na uživatele, který export spustil (funguje v rámci stejné Google Workspace domény)",
      "Pokud převod vlastnictví není možný, export se bezpečně vrátí k dřívějšímu chování (sdílení + uložení do složky vedle databáze)"
    ]
  },
  {
    "version": "2.13.5",
  ...
  },
  {
    ...
    "date": "2026-05-13",
    "changes": [
      "Kalendář nyní řadí oddělení a týmy podle pořadí v DB, vedoucí oddělení zobrazuje vždy první a ostatní zaměstnance řadí podle české abecedy",
      "Zvětšen text čísla a názvu dne v horní řádce kalendáře bez zásahu do vodoznaků v buňkách"
    ]
  },
  {
    "version": "2.11.1",
    "date": "2026-05-12",
    "changes": [
      "GDPR analýza nyní zobrazuje kompletní přehled měsíců: ke smazání, ponecháno v retenci i ponechané dovolené"
    ]
  },
  {
    "version": "2.11.0",
  ...
  },
  {
    ...
    "date": "2026-05-09",
    "changes": [
      "Bezpečnostní stabilizace docházky: schválení a zamítnutí dovolené už nepřepisuje celý ATTENDANCE list",
      "Zamítnutá dovolená se nově uchovává jako stav rejected a ve frontendu ani výpočtech se nezobrazuje",
      "Autosave docházky zapisuje cíleně konkrétní řádky, hromadné mazání má limity, audit logy a nevykonává plošný přepis databáze",
      "Obnovené delete fronty z prohlížeče se už automaticky nepřehrávají a duplicitní hlavičky databázových listů jsou blokovány"
    ]
  },
  {
    "version": "2.10.14",
  ...
  },
  {
    ...
    "date": "2026-04-30",
    "changes": [
      "Administrace oprávnění: GDPR viditelnost statusů je nově plně nastavitelná podle organizačních rolí z POSITIONS.org_role"
    ]
  },
  {
    "version": "2.10.7",
    "date": "2026-04-30",
    "changes": [
      "Administrace oprávnění: doplněn GDPR přehled viditelnosti statusů podle organizační role z POSITIONS.org_role"
    ]
  },
  {
    "version": "2.10.6",
